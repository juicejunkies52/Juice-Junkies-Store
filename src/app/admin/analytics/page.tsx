    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 mt-1">View detailed community statistics</p>
            </div>
          </div>
        </div>
      </motion.header>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <p className="text-gray-400">Detailed analytics will be available in a future update</p>
        </motion.div>
      </main>
    </div>
  )
